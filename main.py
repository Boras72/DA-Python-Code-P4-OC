#main.py (fichier principal pour initialiser et lancer l'application) connecté au MainController qui est le moteur, le main d'oeuvre, le mécanisme principal de ce programme alors que main.py n'est que le déclencheur
